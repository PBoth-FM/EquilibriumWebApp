    ...
    <section id="how-it-works" className="py-24 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center px-6 py-3 bg-white border border-neutral-200 rounded-full text-neutral-700 font-medium mb-6">
            <div className="w-2 h-2 bg-gradient-primary rounded-full mr-3"></div>
            Start seeing results in your first session
          </div>
          <div>
